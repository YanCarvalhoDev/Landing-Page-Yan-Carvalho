...
//         >
//           <span className="w-8 h-8 rounded-lg bg-cyan-600 flex items-center justify-center text-black font-extrabold text-sm font-sans select-none transition-transform group-hover:scale-105">
//             Y
//           </span>
...
//         <nav aria-label="Navegação Principal" className="hidden md:flex items-center gap-6 text-xs font-semibold uppercase tracking-wider text-zinc-300">
//           {navLinks.map((link) => (
//             <button
//               key={link.target}
...
//         {/* Action Button & Mobile Menu controls */}
...
//           {/* Mobile Menu Button - Snappy & glow-highlight styled */}
//           <button
//             onClick={() => setMenuOpen(!menuOpen)}
//             className="md:hidden flex items-center justify-center w-10 h-10 rounded-lg text-zinc-400 hover:text-white hover:bg-zinc-900 border border-zinc-900 active:scale-95 transition-all focus:outline-none focus:ring-1 focus:ring-cyan-500"
...
//       {/* Mobile Navigation Dropdown Overlay with CSS slide-down */}
//       {menuOpen && (
